...
launcherBtn.addEventListener('click', () => {
    ...
    villainSpan.innerHTML = `Villain ${randomVillain} ia armed with a ${randomVillainWeapon}.`;
    ...
    if(heroStrike === VillainStrike) {
        resultMassage = `It's a draw!`;
    } else if(heroStrike > VillainStrike) {
        resultMassage = `${randomHero} defeats ${randomVillain}, and saves the day! `;
    } else {
        resultMassage = `${randomVillain} defeats ${randomHero}. The Dark Side wins!`;
    }

    resultSpan.innerHTML = resultMassage;
